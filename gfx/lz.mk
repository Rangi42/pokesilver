...
gfx/pokedex/pokedex.2bpp.lz: LZFLAGS += --odd-alternate --align 4
gfx/pokedex/question_mark.2bpp.lz: LZFLAGS += --align 4
gfx/pokedex/slowpoke.2bpp.lz: LZFLAGS += --odd-alternate --align 1

gfx/pokegear/pokegear.2bpp.lz: LZFLAGS += --align 4
gfx/pokegear/pokegear_sprites.2bpp.lz: LZFLAGS += --align 4
gfx/pokegear/town_map.2bpp.lz: LZFLAGS += --odd-alternate --align 4
